...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "data-[state=active]:bg-accent data-[state=active]:text-primary inline-flex w-full items-center justify-center rounded-lg bg-[#27272c] p-3 text-base font-medium text-balance whitespace-nowrap text-white ring-offset-white transition-all disabled:pointer-events-none disabled:opacity-50 data-[state=active]:font-bold data-[state=active]:shadow-sm",
        className,
      )}
      {...props}
    />
